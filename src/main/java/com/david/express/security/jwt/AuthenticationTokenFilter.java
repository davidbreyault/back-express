...
public class AuthenticationTokenFilter extends OncePerRequestFilter {
    ...
    private String parseJwt(HttpServletRequest request) {
        String headerAuthorisation = request.getHeader("Authorization");
        if (StringUtils.hasText(headerAuthorisation) && headerAuthorisation.startsWith("Bearer ")) {
            return headerAuthorisation.substring(7);
        }
        return null;
    }
}
